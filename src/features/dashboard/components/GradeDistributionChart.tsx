      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm tabular-nums">
          ...
          <div className="flex items-center gap-2 group cursor-default">
            ...
            <span className="text-muted-foreground">Grade IV: <span className="font-bold text-foreground">{gradeCounts.IV}</span></span>
          </div>
          <div className="flex items-center gap-2 group cursor-default">
            <span className="w-3 h-3 rounded-none bg-muted group-hover:scale-125 transition-transform"></span>
            <span className="text-muted-foreground">Ungraded: <span className="font-bold text-foreground">{gradeCounts.Ungraded}</span></span>
          </div>
        </div>
      </CardContent>
    </Card>
