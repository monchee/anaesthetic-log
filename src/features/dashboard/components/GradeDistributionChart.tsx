  ...
  return (
    <Card className="shadow-sm h-full">
      ...
      <CardContent className="p-6">
        <div className="flex h-12 w-full rounded-none overflow-hidden mb-6 bg-slate-50 dark:bg-slate-800/50">
          {gradeCounts.I > 0 && (
            <div 
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
          ...
          <div className="flex items-center gap-2 group cursor-default">
            <span className="w-3 h-3 rounded-none bg-slate-200 dark:bg-slate-700 group-hover:scale-125 transition-transform"></span>
