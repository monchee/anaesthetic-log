...
export const CSVUploadInstructions: React.FC<CSVUploadInstructionsProps> = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="rounded-none border-l border-slate-200 dark:border-border">
        ...
        <div className="space-y-6">
          <div className="bg-slate-50 dark:bg-card p-4 rounded-none border border-slate-100 dark:border-border">
            <h4 className="font-semibold mb-2 flex items-center gap-2 text-slate-900 dark:text-foreground">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-600 dark:text-foreground/80">
                Click on <span className="font-semibold text-slate-900 dark:text-foreground">Data Exports, Reports, and Stats</span> on the sidebar.
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-600 dark:text-foreground/80">
                Find the <span className="font-semibold text-slate-900 dark:text-foreground">All data (all records and fields)</span> row.
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-600 dark:text-foreground/80">
                Choose <span className="font-semibold text-slate-900 dark:text-foreground">CSV / Microsoft Excel (labels)</span> as the export format.
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-600 dark:text-foreground/80">
                Click <span className="font-semibold text-slate-900 dark:text-foreground">Export Data</span> and download the file.
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-600 dark:text-foreground/80">
                <span className="font-semibold text-slate-900 dark:text-foreground">Ready!</span> Upload the downloaded CSV file using the button below.
              </div>
            </div>
          </div>
