    ...
    <Card className="overflow-hidden print:shadow-none print:border-none">
        ...
        <div className="border-l-4 border-primary bg-slate-50 dark:bg-card/30 p-4 md:p-6 print:bg-white print:border-l-0 print:p-2">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-foreground">Allergy Testing Results</h1>
            <p className="text-sm text-slate-600 dark:text-muted-foreground mt-1">Patient Information Handout</p>
          </div>
        </div>
        ...
        <CardContent className="p-4 md:p-8 lg:p-12 space-y-8 md:space-y-10 print:p-3 print:space-y-2">
           ...
           {/* Header Info */}
            <div className="bg-slate-50 dark:bg-card/30 border border-slate-200 dark:border-border rounded-lg p-4 flex justify-between items-start print:bg-white print:border-slate-300 print:p-2">
               <div>
           ...
           {/* Department Info */}
            <div className="bg-slate-50 dark:bg-card/30 border border-slate-200 dark:border-border rounded-lg p-4 text-sm space-y-2 print:bg-white print:border-slate-300 print:p-2 print:space-y-0.5 print:text-xs">
              ...
              <p className="pt-2 text-slate-600 dark:text-muted-foreground italic print:pt-1 print:text-xs">If you have any questions about these results, please contact the clinic.</p>
           </div>
           ...
           <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4 text-center text-sm print:bg-white print:border-slate-300 print:text-xs">
              ...
              <p className="font-semibold text-slate-900 dark:text-foreground mt-2 print:mt-1">Please provide this document to your anaesthetist before any future surgery.</p>
           </div>
