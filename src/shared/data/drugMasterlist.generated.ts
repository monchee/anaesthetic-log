...
export const GENERATED_PROTOCOLS: DrugProtocol[] = [
  ...
  },
  {
    ...
    drugName: "Amoxycillin/Clavulanic Acid",
    category: "Others",
    testType: "challenge",
    presentation: "125mg/31.25mg per 5mL",
    ...
    sourceSlug: "amoxycillin-clavulanic-acid",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
    id: "oral-graded-challenge",
    drugName: "Amoxycillin Suspension",
    category: "Others",
    testType: "challenge",
    presentation: "125mg/5mL",
    sptNeatConcentration: "",
    diluent: "",
    idtSteps: [],
    challengeSteps: [c(1, "25mg", "1.0 mL", "25mg"), c(2, "50mg", "2.0 mL", "75mg"), c(3, "100mg", "4.0 mL", "175mg"), c(4, "250mg", "10 mL", "425mg")],
    protocolLabel: "Oral Graded Challenge",
    sourceSlug: "amoxycillin-suspension",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
  ...
  },
  {
    ...
    category: "Others",
    testType: "challenge",
    presentation: "40mg/200mg per 5mL suspension",
    sptNeatConcentration: "",
    diluent: "",
    idtSteps: [],
  ...
  {
    id: "suspension",
    drugName: "Cefuroxime Suspension",
    needsPharmacyVerification: true,
    category: "Others",
    testType: "skin",
    presentation: "125mg/5mL",
    ...
    sourceSlug: "cefuroxime-suspension",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
  ...
  {
    id: "standard",
    drugName: "Methoxybenzylpenicillin",
    needsPharmacyVerification: true,
    category: "Penicillins",
    testType: "skin",
    presentation: "",
    ...
    challengeSteps: [],
    protocolLabel: "",
    sourceSlug: "methoxybenzylpenicillin",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
  ...
  {
    id: "rocuronium",
    drugName: "Sugammadex (+ Rocuronium)",
    category: "Reversal Agents",
    testType: "skin",
    presentation: "Mix with Rocuronium 1:1",
    sptNeatConcentration: "Neat (100mg/10mg/mL)",
    diluent: "0.9% sodium chloride",
    idtSteps: [s("1:1,000", "0.1mg/0.01mg/mL"), s("1:100", "1mg/0.1mg/mL")],
    challengeSteps: [],
    protocolLabel: "+ Rocuronium",
    sourceSlug: "sugammadex-rocuronium",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
  ...
  },
  {
    ...
    protocolLabel: "Graded Challenge",
    sourceSlug: "voltaren-diclofenac",
    underReview: false,
    lastReviewed: "2026-03-28",
  },
  {
