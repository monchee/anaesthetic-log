...
const Changelog: React.FC<ChangelogProps> = ({ setScreen }) => {
  const versions = [
    ...
    },
    {
      ...
      highlight: false,
      changes: [
        "Fixed Dashboard CardTitle headings with dark mode text color (were using primary-foreground which is dark in dark mode).",
        "Added dark mode to upload status message for proper visibility.",
      ]
    },
    {
      version: "v0.24.4",
    ...
    },
    {
      ...
      highlight: false,
      changes: [
        "Fixed remaining dark mode issues in TestingPlanPrintView date and 'Additional' headings.",
        "Updated ClinicalReport patient detail labels with dark mode text variants.",
        "Added dark mode backgrounds to ClinicalReport controls box and Assessment & Plan box.",
        "Fixed ClinicalReport table headers and row borders for dark mode visibility.",
        "Applied dark mode fixes to ClinicalReport mobile card views (backgrounds, headings, labels).",
        "Improved contrast for MRN and visit date values in ClinicalReport dark mode.",
      ]
    },
    {
      version: "v0.24.1",
      codename: "Suxamethonium (Patch)",
      highlight: false,
      changes: [
        "Fixed dark mode readability issues with box headings now using proper dark text variants.",
        "Added dark mode backgrounds to testing plan document light boxes.",
        "Fixed drug test values ≥3 highlighting to use dark red backgrounds in dark mode.",
        "Updated clinical report challenge result boxes with dark mode variants.",
        "Applied dark mode fixes to patient handout colored result boxes.",
      ]
    },
    {
      version: "v0.24.0",
